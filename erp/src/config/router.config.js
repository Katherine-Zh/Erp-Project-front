...
import UserAdd from '../views/usermanage/UserInfAdd'
import UserInfAdd from '../views/usermanage/UserInfAdd'
// import UserInfList from '../views/usermanage/UserInfList'
/**
 * 走菜单，走权限控制
 * @type {[null,null]}
 */
export const asyncRouterMap = [

  {
    ...
    children: [
      ...
      //   children: [
      //       {
      //         path: '/userinf/useradd',
      //         name: 'useradd',
      //
      //         component: () => import('@/views/usermanage/UserInfAdd'),
      //         meta: { title: '新增' }
      //       },]
      // },
      // {
      //   path: '/userinf',
      //   redirect: '/userinf/userInf',
      //   component: PageView,
      //   meta: { title: '表单页', icon: 'form', permission: ['form'] },
      //   children: [
      //     {
      //       path: '/userinf/userInf',
      //       name: 'BaseForm',
