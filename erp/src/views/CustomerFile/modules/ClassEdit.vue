    ...
    <a-spin :spinning="confirmLoading">
      <a-form :form="form">
        ...
        <a-form-item label="一级分类编码" :labelCol="labelCol" :wrapperCol="wrapperCol">
          <a-input v-decorator="['parentCode']"></a-input>
        </a-form-item>
        ...
        <a-form-item label="分类编码" :labelCol="labelCol" :wrapperCol="wrapperCol">
          <a-input v-decorator="['classCode']" ></a-input>
        </a-form-item>
  ...
  export default {
    ...
    methods: {
      ...
      edit (record) {
        ...
        this.visible = true;
        this.$nextTick(() => {
          this.form.setFieldsValue(pick(this.model,'parentCode','className','parentCode','parentName'))
        })
      },
      close () {
        this.$emit('close');
