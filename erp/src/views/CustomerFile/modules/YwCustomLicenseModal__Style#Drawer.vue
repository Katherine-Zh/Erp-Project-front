    ...
    <a-spin :spinning="confirmLoading">
      <a-form :form="form">
        ...
        <a-form-item label="证书" :labelCol="labelCol" :wrapperCol="wrapperCol">
          <a-input v-decorator="['certificate']" placeholder="请输入证书"></a-input>
        </a-form-item>
  ...
  export default {
    ...
    methods: {
      ...
      edit (record) {
        ...
        this.visible = true;
        this.$nextTick(() => {
          this.form.setFieldsValue(pick(this.model,'customId','customName','licenseTypeId','licenseType','licenseName','licenseCode','startDate','endDate','remindStatus','authoOrg','firstClassCode','firstClass','controlClassCode','controlClassName','versionFlag','changeTypeFlag','applyChangeReason','certificate','certificateFilePath'))
        })
      },
      close () {
        this.$emit('close');
      ...
      popupCallback(row){
        this.form.setFieldsValue(pick(row,'customId','customName','licenseTypeId','licenseType','licenseName','licenseCode','startDate','endDate','remindStatus','authoOrg','firstClassCode','firstClass','controlClassCode','controlClassName','versionFlag','changeTypeFlag','applyChangeReason','certificate','certificateFilePath'))
      }
