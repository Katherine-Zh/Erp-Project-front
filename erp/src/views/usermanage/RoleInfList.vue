<template>
  <a-card :bordered="false">
    <!-- 查询区域 -->
    <div class="table-page-search-wrapper" id='studentPhoTable'>
...
<!--          handleEdit(record)-->
    ...
    <roleInf-modal ref="modalForm" @ok="modalFormOk"></roleInf-modal>
...
<script>
  ...
  import RoleInfModal from './modules/RoleInfModal'
  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          list: "/roleinf/roleInf/list",
          list2: '/sys/user/userRoleList',
          delete: "/roleinf/roleInf/delete",
          deleteBatch: "/roleinf/roleInf/deleteBatch",
          exportXlsUrl: "/roleinf/roleInf/exportXls",
          importExcelUrl: "roleinf/roleInf/importExcel",
