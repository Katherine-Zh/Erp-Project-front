    ...
    <a-col :md="leftColMd" :sm="24" style="margin-bottom: 20px">
      <a-card :bordered="false">
        ...
        <div class="table-operator" style="margin: 5px 0 10px 2px">
          <a-button @click="handleAdd3" type="primary" icon="plus">新建角色</a-button>
        ...
        <div style="margin-top: 15px">
          ...
          <span slot="action" slot-scope="text, record">
            ...
            <a-dropdown>
              ...
              <a-menu slot="overlay">
                <a-menu-item>
                  <a @click="handlePerssion(record.id,record.roleName)">授权</a>
                </a-menu-item>
                <a-menu-item>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      handlePerssion(roleId,rolename){
        this.$refs.modalUserRole.show(roleId,rolename);
