...
<!--                <a-input :disabled="true" v-decorator="['documentNo', validatorRules.documentNo]" placeholder="请输入单据编号" ></a-input>-->
<!--              </a-form-item>-->
<!--            </a-col>-->
<!--            <a-col :span="8">-->
<!--              <p style="margin-bottom: 0px">单据状态</p>-->
<!--              <a-form-item  :labelCol="labelCol" :wrapperCol="wrapperCol">-->
<!--                <j-dict-select-tag :disabled="true" type="list"  v-decorator="['documentStatus', validatorRules.documentStatus]" :trigger-change="true" dictCode="sd_docu_status" placeholder="请选择状态"/>-->
<!--              </a-form-item>-->
<!--            </a-col>-->
<!--            <a-col span="8">-->
...
<!--              <a-form-item  :labelCol="labelCol" :wrapperCol="wrapperCol">-->
<!--                <j-dict-select-tag type="list" v-decorator="['applyDepart', validatorRules.applyDepart]"  :trigger-change="true" dictCode="sys_depart.id" placeholder="请选择部门"/>-->
<!--              </a-form-item>-->
<!--            </a-col>-->
<!--          </a-row>-->
<!--          <a-row justify="center" style="margin-left: 120px" :gutter="[{ xs: 8, sm: 16, md: 24},{ xs: 8, sm: 16, md: 24}]">-->
...
<!--              <a-form-item  :labelCol="labelCol" :wrapperCol="wrapperCol">-->
<!--                <j-dict-select-tag type="list" v-decorator="['supplierNo', validatorRules.supplierNo]"  :trigger-change="true" dictCode="yw_vendor_info.vendor_id" placeholder="请选择名称" style="width:1195px;"/>-->
<!--              </a-form-item>-->
<!--            </a-col>-->
<!--          </a-row>-->
<!--        </a-form>-->
...
<!--              <a-form-item  :labelCol="labelCol" :wrapperCol="wrapperCol">-->
<!--                <a-input  v-decorator="['manufacture', validatorRules.manufacture]" placeholder="请输入生产企业" style="width:740px;"></a-input>-->
<!--              </a-form-item>-->
<!--            </a-col>-->
<!--          </a-row>-->
<!--          <a-row justify="center" style="margin-left: 120px" :gutter="[{ xs: 8, sm: 16, md: 24},{ xs: 8, sm: 16, md: 24}]">-->
...
<!--              <a-form-item  :labelCol="labelCol" :wrapperCol="wrapperCol">-->
<!--                <a-input  v-decorator="['wareName', validatorRules.wareName]" placeholder="请输入商品单位" ></a-input>-->
<!--              </a-form-item>-->
<!--            </a-col>-->
<!--            <a-col :span="8">-->
...
<!--              <a-form-item  :labelCol="labelCol" :wrapperCol="wrapperCol">-->
<!--                <a-input  v-decorator="['chargeFileNo', validatorRules.chargeFileNo]" placeholder="请输入批准文号/注册证号" style="width:740px;"></a-input>-->
<!--              </a-form-item>-->
<!--            </a-col>-->
<!--            <a-col :span="8">-->
<!--              <p style="margin-bottom: 0px">批准文号/注册证号有效期</p>-->
<!--              <a-form-item  :labelCol="labelCol" :wrapperCol="wrapperCol">-->
<!--                <j-date placeholder="批准文号/注册证号有效期" v-decorator="['manufacture', validatorRules.manufacture ]"  :trigger-change="true" style="width: 100%"/>-->
<!--              </a-form-item>-->
<!--            </a-col>-->
<!--          </a-row>-->
<!--          <a-row justify="center" style="margin-left: 120px" :gutter="[{ xs: 8, sm: 16, md: 24},{ xs: 8, sm: 16, md: 24}]">-->
...
<!--              <a-form-item  :labelCol="labelCol" :wrapperCol="wrapperCol">-->
<!--                <a-input  type="number" v-decorator="['maxPackageNumber', validatorRules.maxPackageNumber]" placeholder="请输入件包装数量" ></a-input>-->
<!--              </a-form-item>-->
<!--            </a-col>-->
<!--            <a-col :span="8">-->
<!--              <p style="margin-bottom: 0px;color: red">中包装数量</p>-->
<!--              <a-form-item  :labelCol="labelCol" :wrapperCol="wrapperCol">-->
<!--                <a-input  type="number" v-decorator="['mediumPackageNumber', validatorRules.mediumPackageNumber]" placeholder="请输入中包装数量" ></a-input>-->
<!--              </a-form-item>-->
<!--            </a-col>-->
<!--            <a-col :span="8">-->
...
<!--              <a-form-item  :labelCol="labelCol" :wrapperCol="wrapperCol">-->
<!--                <a-input  v-decorator="['mainFunction', validatorRules.mainFunction]" placeholder="请输入功能主治" ></a-input>-->
<!--              </a-form-item>-->
<!--            </a-col>-->
<!--          </a-row>-->
<!--          <a-row justify="center" style="margin-left: 120px" :gutter="[{ xs: 8, sm: 16, md: 24},{ xs: 8, sm: 16, md: 24}]">-->
...
<!--              <a-form-item  :labelCol="labelCol" :wrapperCol="wrapperCol">-->
<!--                <j-dict-select-tag type="list"  v-decorator="['recipelType', validatorRules.recipelType]" :trigger-change="true" dictCode="sd_pres_classi" placeholder="请选择单位"/>-->
<!--              </a-form-item>-->
<!--            </a-col>-->
<!--          </a-row>-->
<!--        </a-form>-->
...
<!--              <a-form-item  :labelCol="labelCol" :wrapperCol="wrapperCol">-->
<!--                <j-dict-select-tag type="list"  v-decorator="['inputTaxRate', validatorRules.inputTaxRate]" :trigger-change="true" dictCode="sd_tax_rate" placeholder="请选择单位"/>-->
<!--              </a-form-item>-->
<!--            </a-col>-->
<!--            <a-col :span="8">-->
...
<!--              <a-form-item  :labelCol="labelCol" :wrapperCol="wrapperCol">-->
<!--                <j-dict-select-tag type="list"  v-decorator="['isImport', validatorRules.isImport]" :trigger-change="true" dictCode="sd_yn"-->
<!--                                   placeholder="请选择单位" @change="selectIsJinKou"/>-->
<!--              </a-form-item>-->
<!--            </a-col>-->
<!--          </a-row>-->
<!--          <a-row justify="center" style="margin-left: 120px" :gutter="[{ xs: 8, sm: 16, md: 24},{ xs: 8, sm: 16, md: 24}]">-->
...
<!--              <a-form-item  :labelCol="labelCol" :wrapperCol="wrapperCol">-->
<!--                <a-input v-decorator="['drugProperty',validatorRules.drugProperty]" placeholder="请输入药品性状"></a-input>-->
<!--              </a-form-item>-->
<!--            </a-col>-->
<!--          </a-row>-->
<!--          <a-row justify="center" style="margin-left: 120px" :gutter="[{ xs: 8, sm: 16, md: 24},{ xs: 8, sm: 16, md: 24}]">-->
...
<!--              <a-form-item  :labelCol="labelCol" :wrapperCol="wrapperCol">-->
<!--                <a-input v-decorator="['supplyPrice',validatorRules.supplyPrice]" placeholder="请输入进价"></a-input>-->
<!--              </a-form-item>-->
<!--            </a-col>-->
<!--            <a-col :span="8">-->
<!--              <p style="margin-bottom: 0px">批发价</p>-->
<!--              <a-form-item  :labelCol="labelCol" :wrapperCol="wrapperCol">-->
<!--                <a-input v-decorator="['wholesalePrice',validatorRules.wholesalePrice]" placeholder="请输入批发价"></a-input>-->
<!--              </a-form-item>-->
<!--            </a-col>-->
<!--            <a-col span="8">-->
...
<!--          quary:"/ywfobware/ywFobWare/queryById",-->
...
<!--      },-->
<!--      popupCallback(row){-->
<!--        this.form.setFieldsValue(pick(row,'createBy','createTime','updateBy','updateTime','documentNo','documentStatus','applyReason','applyDate','checkDate','executeDate','applyDepart','supplierNo','wareId','commonName','wareSpeci','wareUnit','manufacture','wareName','englishName','producingArea','chargeFileNo','chargeFileIndate','manufactureClient','packageClient','barCode','wareFirstClass','wareSecondClass','businessType','drugForm','mainFunction','recipelType','inputTaxRate','outputTaxRate','isImport','originCountry','drugProperty','documentArchiveNo','brand','notes','isAnes','isSpecial','maxPackageNumber','mediumPackageNumber','wareIndate','packageMaterial','cureType','storageCondition','gmp','gmpIndate','importLicense','importLicenseIndate','manuLicense','manuLicenseIndate','packageLicense','packageLicenseIndate','wholesalePrice','supplyPrice','salePrice','bakInt1','bakInt2','bakDouble1','bakDouble2','bakChar1','bakChar2'))-->
<!--      },-->
<!--      Reset(){-->
<!--        this.form.resetFields();-->
<!--      },-->
