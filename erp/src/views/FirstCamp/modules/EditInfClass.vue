    ...
    <a-spin :spinning="confirmLoading">
      <a-form :form="form" id ="printpic">
        <a-form-item  :labelCol="labelCol"  :wrapperCol="wrapperCol"  label="一级分类" >
          <a-input :disabled="true"  v-decorator="[' businessOrgId']" />
        </a-form-item>

        <a-form-item  :labelCol="labelCol"  :wrapperCol="wrapperCol"  label="一级分类名称">
          <a-input :disabled="true"  v-decorator="[' businessOrgId']" />
        </a-form-item>

        <a-form-item  :labelCol="labelCol"  :wrapperCol="wrapperCol"  label="分类编码">
          <a-input :disabled="true"  v-decorator="['scatterStallId' ]"/>
  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          add: "/ywwareclass/ywWareClass/add",
          edit: "/ywwareclass/ywWareClass/edit",
        }
      }
    },
    created () {
