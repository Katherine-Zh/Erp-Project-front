      ...
      <a-spin :spinning="confirmLoading">
        <a-form :form="form"  >
          ...
          <a-row justify="center" style="margin-left: 120px" :gutter="[{ xs: 8, sm: 16, md: 24},{ xs: 8, sm: 16, md: 24}]">
            ...
            <a-col :span="8">
              <p style="margin-bottom: 0px">中包装数量</p>
              <a-form-item  :labelCol="labelCol" :wrapperCol="wrapperCol">
            ...
            <a-col :span="8">
              ...
              <a-form-item  :labelCol="labelCol" :wrapperCol="wrapperCol">
                <a-input type="number" v-decorator="['waeIndate', validatorRules.waeIndate]" placeholder="请输入商品有效期(天数)" ></a-input>
              </a-form-item>
            </a-col>
          </a-row>
          <a-row justify="center" style="margin-left: 120px" :gutter="[{ xs: 8, sm: 16, md: 24},{ xs: 8, sm: 16, md: 24}]">
        ...
        <a-row justify="center" style="margin-left: 120px" :gutter="[{ xs: 8, sm: 16, md: 24},{ xs: 8, sm: 16, md: 24}]">
          <a-col span="24">
            ...
            <a-form-item  :labelCol="labelCol" :wrapperCol="wrapperCol">
              <a-input  v-decorator="['updateBy',validatorRules.updateBy]" ></a-input>
            </a-form-item>
          </a-col>
        </a-row>
        <a-row justify="center" style="margin-left: 120px" :gutter="[{ xs: 8, sm: 16, md: 24},{ xs: 8, sm: 16, md: 24}]">
          <a-col span="24">
            ...
            <a-form-item  :labelCol="labelCol" :wrapperCol="wrapperCol">
              <a-textarea  v-decorator="['modifyApplyReason',validatorRules.modifyApplyReason]" ></a-textarea>
            </a-form-item>
          </a-col>
        </a-row>
        <a-row justify="center" style="margin-left: 120px" :gutter="[{ xs: 8, sm: 16, md: 24},{ xs: 8, sm: 16, md: 24}]">
          <a-col span="8">
            ...
            <a-form-item  :labetextlCol="labelCol" :wrapperCol="wrapperCol">
    ...
    data () {
      return {
        ...
        url: {
          ...
          edit: "/ywwareinfo/ywWareInfo/edit",
