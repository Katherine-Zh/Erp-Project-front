        ...
        <a-form :form="form"  >
          <a-row justify="center" style="margin-left: 120px" :gutter="[{ xs: 8, sm: 16, md: 24},{ xs: 8, sm: 16, md: 24}]">
            ...
            <a-col :span="8">
              ...
              <a-form-item  :labelCol="labelCol" :wrapperCol="wrapperCol">
                <a-input :disabled="true" v-decorator="['documentStatus', validatorRules.documentStatus]"></a-input>
              </a-form-item>
            </a-col>
            <a-col :span="8">
        ...
        <a-form :form="form"  >
          ...
          <a-row justify="center" style="margin-left: 120px" :gutter="[{ xs: 8, sm: 16, md: 24},{ xs: 8, sm: 16, md: 24}]">
            <a-col :span="8">
              ...
              <a-form-item  :labelCol="labelCol" :wrapperCol="wrapperCol">
                <a-input v-decorator="['groupType', validatorRules.groupType]" placeholder="请输入企业类型" ></a-input>
              </a-form-item>
            </a-col>
            <a-col :span="16">
          ...
          <a-row justify="center" style="margin-left: 120px" :gutter="[{ xs: 8, sm: 16, md: 24},{ xs: 8, sm: 16, md: 24}]">
            <a-col :span="16">
              ...
              <a-form-item  :labelCol="labelCol" :wrapperCol="wrapperCol">
               <j-area-linkage type="cascader" v-decorator="['address', validatorRules.address]" placeholder="请选择"/>
              </a-form-item>
            </a-col>
            <a-col :span="8">
              <p style="margin-bottom: 0px ;color: red">法人代表</p>
              <a-form-item  :labelCol="labelCol" :wrapperCol="wrapperCol">
          ...
          <a-row justify="center" style="margin-left: 120px" :gutter="[{ xs: 8, sm: 16, md: 24},{ xs: 8, sm: 16, md: 24}]" >
            ...
            <a-col :span="24">
              ...
              <a-form-item  :labelCol="labelCol" :wrapperCol="wrapperCol">
                <JSelectFw v-decorator="['businessScope']"></JSelectFw>
              </a-form-item>
            </a-col>
          ...
          <a-row justify="center" style="margin-left: 120px" :gutter="[{ xs: 8, sm: 16, md: 24},{ xs: 8, sm: 16, md: 24}]" >
            ...
            <a-col :span="24">
              ...
              <a-form-item  :labelCol="labelCol" :wrapperCol="wrapperCol">
               <JSelectPw v-decorator="['pw']"></JSelectPw>
              </a-form-item>
            </a-col>
...
<script>
  ...
  import JSelectPw from '@/components/jeecgbiz/JSelectPw'
    ...
    mounted() {
      ...
      httpAction(this.url.sqbmHttp,"","get").then((res)=>{
        if(res.success){
          ...
          for (var i = 0; i < len; i++) {
            result1[i] = res.result[i]['departName'];
            
            // sqbmall[res.result[i]['depart_name']]=res.result[i]['depart_name']
            // gysPid[res.result[i]['vendor_id']]=res.result[i]['vendor_id']
            // result2[i] = res.result[i]['vendor_id'];
          }
          this.sqbmItems= result1
          // this.gysNo= result2
    ...
    methods: {
      ...
      handleOk () {
        ...
        this.form.validateFields((err, values) => {
          values.departName= sqbmall[values.departName]
          if (!err) {
            ...
            formData['vendorNo']= this.vendorNo
            ...
            httpAction(httpurl,formData,method).then((res)=>{
              ...
              // document.cookie = "key=" + this.vendorNo;
              that.confirmLoading = false;
              that.close();
              // console.log("表单提交数据",document.cookie)
              that.$router.push({path:"/Vendor/sup/SupCer"})
            })
          }else {
