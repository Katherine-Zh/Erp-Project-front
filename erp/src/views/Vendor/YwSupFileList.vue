<template>
  <a-card :bordered="false">
    ...
    <div class="table-operator">
      <a-button @click="handleAdd13" type="primary" icon="plus">新建</a-button>
      <a-button type="primary" icon="download" @click="handleExportXls('子结算清单信息')">导出</a-button>
    ...
    <div>
      ...
      <a-table
        ...
        <span slot="action" slot-scope="text, record">
           <a @click="handleEdit9(record)">编辑</a>
    ...
    data () {
      return {
        ...
        url: {
          ...
          softDelBatch: "/ywvendorsettlelist/ywVendorSettleList/softDelBatch",
          softDel: "/ywvendorsettlelist/ywVendorSettleList/softDel",
