      ...
      <a-form id="ddd" :form="form"  >
        <a-row justify="center" style="margin-left: 120px" :gutter="[{ xs: 8, sm: 16, md: 24},{ xs: 8, sm: 16, md: 24}]">
          <a-col :span="8">
            ...
            <a-form-item  :labelCol="labelCol" :wrapperCol="wrapperCol">
              <a-input  v-decorator="['vendorNo', validatorRules.vendorNo]"  ></a-input>
            </a-form-item>
          </a-col>
          <a-col :span="16">
        ...
        <a-row justify="center" style="margin-left: 120px" :gutter="[{ xs: 8, sm: 16, md: 24},{ xs: 8, sm: 16, md: 24}]">
          ...
          <a-col :span="8">
            ...
            <a-form-item  :labelCol="labelCol" :wrapperCol="wrapperCol">
              <a-input :disabled="true" v-decorator="['useStatus', validatorRules.useStatus]" dictCode="sd_status" ></a-input>
            </a-form-item>
          </a-col>
        </a-row>
        <a-row justify="center" style="margin-left: 120px" :gutter="[{ xs: 8, sm: 16, md: 24},{ xs: 8, sm: 16, md: 24}]">
          ...
          <a-col :span="8">
            ...
            <a-form-item  :labelCol="labelCol" :wrapperCol="wrapperCol" >
              <j-dict-select-tag type="list"  v-decorator="['businessUnitType', validatorRules.businessUnitType]" :trigger-change="true" dictCode="" placeholder="请选择类型"/>
            </a-form-item>
          </a-col>
          <a-col :span="8">
        ...
        <a-row justify="center" style="margin-left: 120px" :gutter="[{ xs: 8, sm: 16, md: 24},{ xs: 8, sm: 16, md: 24}]">
          ...
          <a-col :span="8">
            ...
            <a-form-item  :labelCol="labelCol" :wrapperCol="wrapperCol" >
              <a-input  v-decorator="['serviceStatus', validatorRules.serviceStatus]"  ></a-input>
            </a-form-item>
          </a-col>
        </a-row>
        <a-row justify="center" style="margin-left: 120px" :gutter="[{ xs: 8, sm: 16, md: 24},{ xs: 8, sm: 16, md: 24}]">
          <a-col :span="8">
            ...
            <a-form-item  :labelCol="labelCol" :wrapperCol="wrapperCol" >
              <a-input  v-decorator="['settleStatus', validatorRules.settleStatus]"  ></a-input>
            </a-form-item>
          </a-col>
          <a-col :span="8">
            <p style="margin-bottom: 0px ;color:red">纳税类型</p>
            <a-form-item  :labelCol="labelCol" :wrapperCol="wrapperCol" >
              <j-dict-select-tag type="list" v-decorator="['taxType', validatorRules.taxType]" :trigger-change="true" dictCode="sd_docu_status" placeholder="请选择状态"/>
            </a-form-item>
          </a-col>
          <a-col :span="8">
            <p style="margin-bottom: 0px ">注册资本（万元）</p>
            <a-form-item  :labelCol="labelCol" :wrapperCol="wrapperCol" >
              <a-input  v-decorator="['registerCapital', validatorRules.registerCapital]"  ></a-input>
            </a-form-item>
          </a-col>
        </a-row>
        <a-row justify="center" style="margin-left: 120px" :gutter="[{ xs: 8, sm: 16, md: 24},{ xs: 8, sm: 16, md: 24}]">
        ...
        <a-row justify="center" style="margin-left: 120px" :gutter="[{ xs: 8, sm: 16, md: 24},{ xs: 8, sm: 16, md: 24}]">
          <a-col :span="8">
            ...
            <a-form-item  :labelCol="labelCol" :wrapperCol="wrapperCol" >
              <a-input  v-decorator="['cuscco', validatorRules.cuscc]"  ></a-input>
            </a-form-item>
          </a-col>
          <a-col :span="8">
        ...
        <a-row justify="center" style="margin-left: 120px" :gutter="[{ xs: 8, sm: 16, md: 24},{ xs: 8, sm: 16, md: 24}]">
          ...
          <a-col :span="8">
            ...
            <a-form-item  :labelCol="labelCol" :wrapperCol="wrapperCol" >
              <j-dict-select-tag type="list"  v-decorator="['isTwoLicense', validatorRules.isTwoLicense]" :trigger-change="true" dictCode="" placeholder="请选择"/>
            </a-form-item>
          </a-col>
        </a-row>
        <a-row justify="center" style="margin-left: 120px" :gutter="[{ xs: 8, sm: 16, md: 24},{ xs: 8, sm: 16, md: 24}]">
        ...
        <a-row justify="center" style="margin-left: 120px" :gutter="[{ xs: 8, sm: 16, md: 24},{ xs: 8, sm: 16, md: 24}]">
          <a-col span="24">
            <p style="margin-bottom: 0px;color:red">申请原因</p>
            <a-form-item  :labelCol="labelCol" :wrapperCol="wrapperCol">
              <a-input  v-decorator="['modifyApplyReason',validatorRules.modifyApplyReason]" ></a-input>
            </a-form-item>
          </a-col>
        </a-row>
        <a-row justify="center" style="margin-left: 120px" :gutter="[{ xs: 8, sm: 16, md: 24},{ xs: 8, sm: 16, md: 24}]">
          <a-col span="24">
            ...
            <a-form-item  :labelCol="labelCol" :wrapperCol="wrapperCol">
              <a-textarea  v-decorator="['modifyColumnChinese',validatorRules.modifyColumnChinese]" ></a-textarea>
            </a-form-item>
          </a-col>
        </a-row>
    ...
    data () {
      return{
        ...
        validatorRules: {
          ...
          modifyApplyReason: {
            rules: [
              { required: false, message: '申请原因!' },
            ]
          },
          modifyColumnChinese: {
            rules: [
              { required: false, message: '修改内容!' },
            ]
          },
          url: {
        ...
        methods: {
          ...
          edit (record) {
            ...
            this.visible = true;
            this.$nextTick(() => {
              this.form.setFieldsValue(pick(this.model,'vendorName','wareName','oldName','useStatus','woriginCode','businessUnitType','legalPerson','address','registerAddress','bankAcount','bankName','serviceStatus','settleStatus','taxType','registerCapital','buyer','companySupervisedCode','produceArea','companyChargePerson','outputTaxRate','companyEstablishTime','telephone','fax','mobilePhone','email','url','dataSource','orderIndate','cuscco','taxRegistrationAccount','registerCountry','qualityIncharge','elecSupervisedCode','isTwoLicense','fobTime','endBusinessTime','archiveNo','archiveDate','documentCreateTime','illustration','notes','modifyApplyReason','modifyColumnChinese'))
            })
          },
          close () {
            this.$emit('close');
          ...
          popupCallback(row){
            this.form.setFieldsValue(pick(row,'vendorName','wareName','oldName','useStatus','woriginCode','businessUnitType','legalPerson','address','registerAddress','bankAcount','bankName','serviceStatus','settleStatus','taxType','registerCapital','buyer','companySupervisedCode','produceArea','companyChargePerson','outputTaxRate','companyEstablishTime','telephone','fax','mobilePhone','email','url','dataSource','orderIndate','cuscco','taxRegistrationAccount','registerCountry','qualityIncharge','elecSupervisedCode','isTwoLicense','fobTime','endBusinessTime','archiveNo','archiveDate','documentCreateTime','illustration','notes','modifyApplyReason','modifyColumnChinese'))
          },
          Reset(){
            this.form.resetFields();
          },
