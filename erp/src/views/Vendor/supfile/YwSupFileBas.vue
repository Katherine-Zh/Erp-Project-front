    ...
    <div style="background-color: white">
      ...
      <a-spin :spinning="confirmLoading">
        <a-form id="ddd" :form="form"  >
          ...
          <a-row justify="center" style="margin-left: 120px" :gutter="[{ xs: 8, sm: 16, md: 24},{ xs: 8, sm: 16, md: 24}]">
            <a-col :span="8">
              <p style="margin-bottom: 0px">供应商助记码</p>
              <a-form-item  :labelCol="labelCol" :wrapperCol="wrapperCol">
                <a-input :disabled="true" v-decorator="['vendorAbc', validatorRules.vendorAbc]"  ></a-input>
              </a-form-item>
            </a-col>
            <a-col :span="8">
          ...
          <a-row justify="center" style="margin-left: 120px" :gutter="[{ xs: 8, sm: 16, md: 24},{ xs: 8, sm: 16, md: 24}]">
            ...
            <a-col :span="8">
              ...
              <a-form-item  :labelCol="labelCol" :wrapperCol="wrapperCol" >
                <a-input min ="0" type="number" v-decorator="['registerCapital', validatorRules.registerCapital]"  ></a-input>
              </a-form-item>
            </a-col>
          </a-row>
          <a-row justify="center" style="margin-left: 120px" :gutter="[{ xs: 8, sm: 16, md: 24},{ xs: 8, sm: 16, md: 24}]">
        ...
        validatorRules: {
          ...
          telephone:{
            rules: [
              ...
              { pattern:/^((0\d{2,3}-\d{7,8})|(1[3584]\d{9}))$/, message: '请输入正确的联系电话!'},
            ]
          },
          fax: {
            rules: [
          ...
          mobilePhone: {
            rules: [
              ...
              { pattern:/^((0\d{2,3}-\d{7,8})|(1[3584]\d{9}))$/, message: '请输入正确的手机号!'},
            ]
          },
          email: {
            rules: [
            ...
            this.form.validateFields((err, values) => {
              ...
              if (!err) {
                ...
                httpAction(httpurl,formData,method).then((res)=>{
                  ...
                  that.close();
                  that.$router.push({path:"/Vendor/supfile/YwSupFileBusSco"})
                })
              }else {
