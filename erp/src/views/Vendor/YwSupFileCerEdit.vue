        ...
        <a-form :form="form"  >
          ...
          <a-row justify="center" style="margin-left: 120px" :gutter="[{ xs: 8, sm: 16, md: 24},{ xs: 8, sm: 16, md: 24}]" >
            ...
            <a-col :span="8">
              ...
              <a-form-item  :labelCol="labelCol" :wrapperCol="wrapperCol">
                <a-input :disabled="true" v-decorator="['authoOrg', validatorRules.authoOrg]" placeholder="" ></a-input>
              </a-form-item>
            </a-col>
          </a-row>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      handReturn () {
        this.$router.push({path:"/Vendor/YwSupFileCer"})
      },
      edit (record) {
        ...
        this.form.validateFields((err, values) => {
          ...
          if (!err) {
            ...
            httpAction(httpurl,formData,method).then((res)=>{
              ...
              that.close();
              that.$router.push({path:"/Vendor/YwSupFileCer"})
            })
          }else {
